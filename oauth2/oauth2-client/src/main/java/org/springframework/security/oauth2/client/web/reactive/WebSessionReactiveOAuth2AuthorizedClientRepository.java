 ...
 */
public final class WebSessionReactiveOAuth2AuthorizedClientRepository implements ReactiveOAuth2AuthorizedClientRepository {
	private static final String DEFAULT_AUTHORIZED_CLIENTS_ATTR_NAME =
			WebSessionReactiveOAuth2AuthorizedClientRepository.class.getName() +  ".AUTHORIZED_CLIENTS";
