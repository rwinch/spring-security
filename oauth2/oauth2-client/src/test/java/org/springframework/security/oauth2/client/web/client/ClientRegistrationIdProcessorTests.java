...
import static org.springframework.security.oauth2.client.web.client.ClientRegistrationIdProcessorTests.RestService.REGISTRATION_ID;
...
class ClientRegistrationIdProcessorTests {
	...
	void processWhenClientRegistrationIdPresentThenSet() {
		...
		processor.process(hasClientRegistrationId, null, builder);
