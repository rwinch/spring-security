 ...
 * @author Rob Winch
 */
public class AuthenticatedPrincipalReactiveOAuth2AuthorizedClientRepositoryTests {
	private String registrationId = "registrationId";
	private String principalName = "principalName";
	private ReactiveOAuth2AuthorizedClientService authorizedClientService;
	private ReactiveOAuth2AuthorizedClientRepository anonymousAuthorizedClientRepository;
	private AuthenticatedPrincipalReactiveOAuth2AuthorizedClientRepository authorizedClientRepository;
	...
	public void setup() {
		...
		this.anonymousAuthorizedClientRepository = mock(ReactiveOAuth2AuthorizedClientRepository.class);
		this.authorizedClientRepository = new AuthenticatedPrincipalReactiveOAuth2AuthorizedClientRepository(this.authorizedClientService);
