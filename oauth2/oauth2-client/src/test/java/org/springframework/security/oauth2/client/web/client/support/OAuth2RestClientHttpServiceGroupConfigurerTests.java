...
class OAuth2RestClientHttpServiceGroupConfigurerTests {
	...
	@Captor
	ArgumentCaptor<HttpServiceGroupConfigurer.ForProxyFactory> forProxyFactory;

	@Mock
	private HttpServiceProxyFactory.Builder factoryBuilder;

	@Captor
	private ArgumentCaptor<HttpServiceGroupConfigurer.ForClient<RestClient.Builder>> configureClient;
	...
	void configureGroupsConfigureProxyFactory() {
		...
		this.forProxyFactory.getValue().configureProxyFactory(null, this.factoryBuilder);
	...
	void configureGroupsConfigureClient() {
		...
		this.configureClient.getValue().configureClient(null, this.clientBuilder);
