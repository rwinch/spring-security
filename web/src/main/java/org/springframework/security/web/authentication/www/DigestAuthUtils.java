...
final class DigestAuthUtils {
	...
	static String encodePasswordInA1Format(@Nullable String username, @Nullable String realm, @Nullable String password) {
	 ...
	 */
	static String generateDigest(boolean passwordAlreadyEncoded, @Nullable String username, @Nullable String realm, @Nullable String password,
			String httpMethod, @Nullable String uri, @Nullable String qop, @Nullable String nonce, @Nullable String nc, @Nullable String cnonce)
