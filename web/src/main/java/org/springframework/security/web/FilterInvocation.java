...
public class FilterInvocation {
	...
	private @Nullable FilterChain chain;
	...
	public FilterInvocation(@Nullable String contextPath, String servletPath, @Nullable String method, @Nullable ServletContext servletContext) {
	...
	public FilterInvocation(@Nullable String contextPath, String servletPath, @Nullable String pathInfo, @Nullable String query, @Nullable String method,
	...
	@NullUnmarked public FilterChain getChain() {
		return this.chain;
	}
	...
	@NullUnmarked public HttpServletResponse getHttpResponse() {
